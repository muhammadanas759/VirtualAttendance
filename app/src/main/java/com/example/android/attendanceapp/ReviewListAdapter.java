...
checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                ...
                // you have to create a method named as onItemClick in the parent activiy of fragment
                //send the context of activiy
                //then do this

                ((tab)context).onItemClick(data.get(getLayoutPosition()));
            }
        });        }
    }
